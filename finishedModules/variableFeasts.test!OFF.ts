...
import { returnVariableFeastFromChurchMoment } from './variableFeasts';
import { paschaCalculation } from './paschaCalculation'
...
// });
let pascha2020 = paschaCalculation(moment("2020"));
...
test('2020 Pascha is April 19. Expect Thomas Sunday for 7528 to be April 13', () => { 
...
test('2020 Pascha is April 19. Expect Bright Tuesday for 7528 to be April 8', () => { 
